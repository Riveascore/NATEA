...
class PhoneNumbersControllerTest < ActionController::TestCase
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post :create, phone_number: { area_code: @phone_number.area_code, country_code: @phone_number.country_code, donator_id: @phone_number.donator_id, main_contact: @phone_number.main_contact, number: @phone_number.number }
    end
  ...
  test "should update phone_number" do
    patch :update, id: @phone_number, phone_number: { area_code: @phone_number.area_code, country_code: @phone_number.country_code, donator_id: @phone_number.donator_id, main_contact: @phone_number.main_contact, number: @phone_number.number }
    assert_redirected_to phone_number_path(assigns(:phone_number))
  end
